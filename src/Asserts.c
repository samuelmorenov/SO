...
char *elements[]={
	...
	"MMBR_OP",	// Main MEMory Memory Memory Buffer Register OPeration code
...
void Asserts_CheckOneAssert(int na){
	...
	switch (op) {
		case RMEM_OP: 
				operationCode=Processor_DecodeOperationCode(mainMemory[MMU_GetBase()+asserts[na].address]);
				// if ((mainMemory[MMU_GetBase()+asserts[na].address].operationCode!=(char)asserts[na].value) || GEN_ASSERTS)
				if ((operationCode!=(char)asserts[na].value) || GEN_ASSERTS)
				...
				break;
		case RMEM_O1:  	
				operand1=Processor_DecodeOperand1(mainMemory[MMU_GetBase()+asserts[na].address]);
				// if ((mainMemory[MMU_GetBase()+asserts[na].address].operand1!=(char)asserts[na].value) || GEN_ASSERTS)
				if ((operand1!=(char)asserts[na].value) || GEN_ASSERTS)
				...
				break;		
		case RMEM_O2:
				operand2=Processor_DecodeOperand2(mainMemory[MMU_GetBase()+asserts[na].address]);
				// if ((mainMemory[MMU_GetBase()+asserts[na].address].operand2!=(char)asserts[na].value) || GEN_ASSERTS)
				if ((operand2!=(char)asserts[na].value) || GEN_ASSERTS)
			  	...
			  	break;
		case AMEM_OP: 				       
				operationCode=Processor_DecodeOperationCode(mainMemory[asserts[na].address]);
				...
				if ((operationCode!=(char)asserts[na].value) || GEN_ASSERTS)
			 	...
			 	break;
		case AMEM_O1:  
				operand1=Processor_DecodeOperand1(mainMemory[asserts[na].address]);
				...
				if ((operand1!=asserts[na].value)|| GEN_ASSERTS)
					...
					assertMsg(globalCounter,"AMEM_01",asserts[na].value,operand1,asserts[na].address);
			 	break;
		case AMEM_O2:
				operand2=Processor_DecodeOperand2(mainMemory[asserts[na].address]);
				...
				if ((operand2!=asserts[na].value)|| GEN_ASSERTS)
					...
					assertMsg(globalCounter,"AMEM_02",asserts[na].value,operand2,asserts[na].address);
			 	break;	 		 	
		case PC:  
		...
		case IR_O1:
				...
				if ((operand1!= asserts[na].value)|| GEN_ASSERTS)
					...
					assertMsg(globalCounter,"IR_01",asserts[na].value,operand1,0);
				break;
		case IR_O2:
				...
				if ((operand2!=asserts[na].value)|| GEN_ASSERTS)
					...
					assertMsg(globalCounter,"IR_02",asserts[na].value,operand2,0);			
				break;
		case PSW:
		...
		case MBR_O2:
				...
				if ((operand2!=asserts[na].value) || GEN_ASSERTS)
					...
					assertMsg(globalCounter,"MBR_02",asserts[na].value,operand2,0);			
				break;
		case MMU_BS:
